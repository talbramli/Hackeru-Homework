...
class User {
  ...
  setName({ first, last }: name): string {
...
const sumbit = document.getElementById("sumbit")! as HTMLButtonElement;
const email = document.getElementById("email")! as HTMLInputElement;
const password = document.getElementById("password")! as HTMLInputElement;
const success = document.getElementById("success")! as HTMLDivElement;
const fail = document.getElementById("fail")! as HTMLDivElement;
